...
import main.java.example.movies.executor.CypherExecutor;
import main.java.example.movies.executor.BoltCypherExecutor;
...
public class MovieService {
    ...
    private CypherExecutor createCypherExecutor(String uri) {
        try {
            ...
            System.out.println(uri+" :auth:"+auth);
            if (auth != null) {
    ...
    public Map<String, Object> graph(int limit) {
    	System.out.println("graph data base is calling...");
